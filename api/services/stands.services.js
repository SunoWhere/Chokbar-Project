...
// const StandType = require("../database/db").DB_models.stand_types
// const ProductsModel = require("../database/db").DB_models.products
// const StandImagesModel = require("../database/db").DB_models.stands_images
// const ProvidersModel = require("../database/db").DB_models.providers
// const LocationsModel = require("../database/db").DB_models.locations
// const LocationSizesModel = require("../database/db").DB_models.location_sizes
//
