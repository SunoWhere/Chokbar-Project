...
import {faUser, faCartShopping, faEnvelope} from '@fortawesome/free-solid-svg-icons'
...
library.add(faUser, faCartShopping, faEnvelope, faFacebook, faSquareXTwitter, faTiktok, faInstagram); // Solid Icons
