...
export const lang_fr = {
    ...
    navbar_map: "Carte",
    navbar_billetterie: "Billetterie",
    navbar_boutique: "Stands",
    navbar_apropos: "À propos",
    navbar_dp_ezcon: "La EZCON",
    navbar_dp_dates: "Dates, Horaires, Accès",
    navbar_dp_decouvrir: "À découvrir",
    navbar_login: "Se connecter",
    navbar_logout: "Se déconnecter",
    navbar_panier: "Panier",
    ...
    home_third_p_title: "Réalité virtuelle, EVA...",
    home_third_p: "Pour l'édition 2024, une expérience VR exceptionnelle s'offre à nous avec\n" +
    ...
    footer_presentation_second: "Rejoignez-nous pour une expérience unique! Explorez des mondes virtuels,\n" +
    ...
    footer_infos_pratiques: "INFORMATIONS",
    footer_questions: "Questions fréquentes",
    footer_activite: "Activités",
    ...
    crud_stands_location: "Position",
    crud_stands_nb_product: "Produits",
