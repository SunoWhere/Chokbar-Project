...
export default {
  ...
  methods: {
    changeSelectedBooth(e) {
      this.selectedBooth = e.target.id
    }
  }
}
</script>
...
<template>
    <div>
      <h1>{{ this.selectedBooth }}</h1>
      <svg width="100%" height="100%" viewBox="0 0 2236 1578" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:square;stroke-miterlimit:1.5;">
        <g transform="matrix(1,0,0,1,-783.554,-346.752)">
          ...
          <g transform="matrix(2.01497e-16,-3.2907,1,6.12323e-17,2275.92,4680.76)">
              <rect id="Scène" v-on:click="e => changeSelectedBooth(e)" x="973.413" y="542.788" width="138.14" height="170.265" />
          </g>
          ...
          <g transform="matrix(1.27907,0,0,1,1272.39,707.477)">
              <rect id="A27" v-on:click="e => changeSelectedBooth(e)" x="973.413" y="542.788" width="138.14" height="170.265" />
          </g>
          <g transform="matrix(1.27907,0,0,1,1095.7,707.477)">
              <rect id="A28" v-on:click="e => changeSelectedBooth(e)" x="973.413" y="542.788" width="138.14" height="170.265" />
          </g>
          <g transform="matrix(1.27907,0,0,1,1083.4,1098.62)">
              <rect id="A29" v-on:click="e => changeSelectedBooth(e)" x="973.413" y="542.788" width="138.14" height="170.265" />
          </g>
        </g>
      </svg>
    </div>
