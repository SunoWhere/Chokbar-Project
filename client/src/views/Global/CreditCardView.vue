              ...
              <div class="card-item__top">
                ...
                <div class="card-item__type">
                  <transition name="slide-fade-up">
                    <div class="card-item__typeImg">VISA</div>
                  </transition>
                </div>
              </div>
                  ...
                  <transition name="slide-fade-up">
                    <div class="card-item__name" v-if="cardName.length" key="1">
                      <transition-group name="slide-fade-right">
                        <span class="card-item__nameItem" v-for="(n, $index) in filteredCardName" :key="$index + 1">{{
                            n
                          }}</span>
                      </transition-group>
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      cardYear: "",
      cardCvv: "",
      minCardYear: new Date().getFullYear() + 1,
      amexCardMask: "#### ###### #####",
      otherCardMask: "#### #### #### ####",
      cardNumberTemp: "",
      isCardFlipped: false,
...
.card-form__button {
  width: 100%;
  height: 55px;
  background: var(--scnd2);
  border: none;
  border-radius: 5px;
  font-size: 22px;
  font-weight: 500;
  font-family: "Source Sans Pro", sans-serif;
  box-shadow: 3px 10px 20px 0px var(--background);
  color: #fff;
  margin-top: 20px;
  cursor: pointer;
}
